 ...
 * @since 13 Jun 2017
 */
@ComponentInformation(name = "XEditable Html Number Component",
        description = "The Html 6 Types XEditable Component",
        url = "https://vitalets.github.io/x-editable/docs.html#html5types")
public class XEditableNumber extends XEditable<XEditableHtml5TypesOptions>
{
     ...
     */
    public XEditableNumber()
    {
        getFeature().setOptions(new XEditableHtml5TypesOptions(XEditableDataTypes.Number));
    }
