 ...
 * @since 13 Jun 2017
 */
@ComponentInformation(name = "XEditable Html Range Component",
        description = "The Html 6 Types XEditable Component",
        url = "https://vitalets.github.io/x-editable/docs.html#html5types")
public class XEditableRange extends XEditable<XEditableHtml5TypesOptions>
{
     ...
     */
    public XEditableRange()
    {
        getFeature().setOptions(new XEditableHtml5TypesOptions(XEditableDataTypes.Range));
    }
