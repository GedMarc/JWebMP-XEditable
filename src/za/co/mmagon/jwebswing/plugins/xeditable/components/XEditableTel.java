 ...
 * @since 13 Jun 2017
 */
@ComponentInformation(name = "XEditable Html Tel Component",
		description = "The Html 6 Types XEditable Component",
		url = "https://vitalets.github.io/x-editable/docs.html#html5types")
public class XEditableTel extends XEditable<XEditableHtml5TypesOptions>
{
	...
	public XEditableTel()
	{
		getFeature().setOptions(new XEditableHtml5TypesOptions(XEditableDataTypes.Tel));
	}
