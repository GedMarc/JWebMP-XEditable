...
import za.co.mmagon.jwebswing.generics.Positions;
...
public class XEditableOptions<O extends XEditableOptions> extends JavaScriptPart
{
	 ...
	 * <p>
	 * When set to manual you should manually call show/hide methods of editable. Note: if you call show or toggle inside click handler of some DOM element, you need to apply e.stopPropagation()
