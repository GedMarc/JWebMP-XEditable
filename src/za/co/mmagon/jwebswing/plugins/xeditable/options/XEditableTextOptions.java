 ...
 * @since 13 Jun 2017
 */
public class XEditableTextOptions extends XEditableOptions<XEditableTextOptions>
{
     ...
     * @return
     */
    public XEditableTextOptions setEscape(Boolean escape)
    {
        this.escape = escape;
        return this;
    }
     ...
     * @return
     */
    public XEditableTextOptions setInputClass(String inputClass)
    {
     ...
     * @return
     */
    public XEditableTextOptions setPlaceHolder(String placeHolder)
    {
